<div class="header">
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                <span class="user-img"><img src="{{ url('admin/images/photos/'.Auth::guard('admin')->user()->photo) }}" alt="">
                ...
                <div class="profilename">
                    <div class="profileset">
                        ...
                        <div class="profilesets">
                            ...
                            <h5>{{ Auth::guard('admin')->user()->tipe }}</h5>
                        </div>
                    </div>
                    <hr class="m-0">
    ...
    <div class="dropdown mobile-user-menu">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            <a class="dropdown-item" href="{{ url('admin/update-admin-profile') }}">Profilku</a>
            <a class="dropdown-item" href="{{ url('admin/update-admin-password') }}">Ubah Password</a>
            <a class="dropdown-item" href="{{ url('admin/logout') }}">Keluar</a>
        </div>
    </div>
